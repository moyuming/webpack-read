...
class Compilation extends Tapable {
	 ...
	 * @param {Dependency} dependency 用于创建模块链的依赖项
	 * @param {OnModuleCallback} onModule 创建模块时调用的函数
	 * @param {ModuleChainCallback} callback 模块链完成时的回调
	...
	/**
	 *
	 * @param {string} context 入口上下文路径
	 * @param {Dependency} entry 被创建的入口依赖
	 * @param {string} name 入口的名字
